...
def mlmc(mlmc_l, N0, eps, Lmin, Lmax, alpha0, beta0, gamma0, Nlfile, *args):
    ...
    eps_str = str(eps).replace('.', '_')  
    ax14.figure.savefig(f'14_Nepsilon_{eps_str}.svg', format='svg', dpi=1200)
    plt.tight_layout()
    plot_filename = f'14_Nepsilon_{eps_str}.pkl'
    ...
    eps_str = str(eps).replace('.', '_')  
    ax15.figure.savefig(f'15_Oepsilon_{eps_str}.svg', format='svg', dpi=1200)
    plt.tight_layout()
    plot_filename = f'15_Oepsilon_{eps_str}.pkl'
    ...
    eps_str = str(eps).replace('.', '_')  
    ax16.figure.savefig(f'16_NOepsilon_{eps_str}.svg', format='svg', dpi=1200)
    plt.tight_layout()
    plot_filename = f'16_NOepsilon_{eps_str}.pkl'
    ...
    eps_str = str(eps).replace('.', '_')  
    ax17.figure.savefig(f'17_N2epsilon_{eps_str}.svg', format='svg', dpi=1200)
    plt.tight_layout()
    plot_filename = f'17_N2epsilon_{eps_str}.pkl'
    ...
    eps_str = str(eps).replace('.', '_')  
    ax18.figure.savefig(f'18_O2epsilon_{eps_str}.svg', format='svg', dpi=1200)
    plt.tight_layout()
    plot_filename = f'18_O2epsilon_{eps_str}.pkl'
