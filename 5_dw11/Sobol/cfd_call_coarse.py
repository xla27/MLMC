...
def cfd_call_coarse(valIns_M, valIns_T, valIns_P, valIns_Bn2, valIns_Bo2, l, i):
    baseFolder = '/global-scratch/bulk_pool/nsarman/sobol_dw11/'
    stringPart = 'level'
    ...
    fileContents)
        ...
        if os.path.isfile(csv_path_surf):
            ...
            p_i = (data_surf['Var30'] ).tolist() # pressure 
            Ttr_i = (data_surf['Var31'] ).tolist() # rototranslational temperature
            Tve_i = (data_surf['Var32'] ).tolist() # vibrational temperature
            M_i = (data_surf['Var35'] ).tolist() # mach
