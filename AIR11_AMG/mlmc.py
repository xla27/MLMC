       ...
       # Update sample sums
        ...
        for l in range(L+1):
            ...
            if dNl[l] > 0:
                ...
                [x_ref, sums1, sums2, _, _, sums1ndelecMinus, sums2ndelecMinus, sums1ndNPlus, sums2ndNPlus, sums1ndOPlus, 
                ...
                if cellsom1P[l] is None:
                    ...
                    if len(x_ref) >= len(cellnodes[l]):
                        ...
                        sums1ndelecMinus = interp1d(x_ref, sums1ndelecMinus, kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2ndelecMinus = interp1d(x_ref, sums2ndelecMinus, kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1ndNPlus     = interp1d(x_ref, sums1ndNPlus,     kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2ndNPlus     = interp1d(x_ref, sums2ndNPlus,     kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1ndOPlus     = interp1d(x_ref, sums1ndOPlus,     kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2ndOPlus     = interp1d(x_ref, sums2ndOPlus,     kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1ndNOPlus    = interp1d(x_ref, sums1ndNOPlus,    kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2ndNOPlus    = interp1d(x_ref, sums2ndNOPlus,    kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1ndN2Plus    = interp1d(x_ref, sums1ndN2Plus,    kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2ndN2Plus    = interp1d(x_ref, sums2ndN2Plus,    kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1ndO2Plus    = interp1d(x_ref, sums1ndO2Plus,    kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2ndO2Plus    = interp1d(x_ref, sums2ndO2Plus,    kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1elecMinus   = interp1d(x_ref, sums1elecMinus,   kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2elecMinus   = interp1d(x_ref, sums2elecMinus,   kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1NPlus       = interp1d(x_ref, sums1NPlus,       kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2NPlus       = interp1d(x_ref, sums2NPlus,       kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1OPlus       = interp1d(x_ref, sums1OPlus,       kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2OPlus       = interp1d(x_ref, sums2OPlus,       kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1NOPlus      = interp1d(x_ref, sums1NOPlus,      kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2NOPlus      = interp1d(x_ref, sums2NOPlus,      kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1N2Plus      = interp1d(x_ref, sums1N2Plus,      kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2N2Plus      = interp1d(x_ref, sums2N2Plus,      kind='linear', fill_value='extrapolate')(cellnodes[l])
                        sums1O2Plus      = interp1d(x_ref, sums1O2Plus,      kind='linear', fill_value='extrapolate')(cellnodes[l]); sums2O2Plus      = interp1d(x_ref, sums2O2Plus,      kind='linear', fill_value='extrapolate')(cellnodes[l])
